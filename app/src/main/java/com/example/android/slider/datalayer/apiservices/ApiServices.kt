...
interface APIServices{
    ...
    fun getProductsInfo():Observable<ProductModel>
companion object{
     ...
     fun create(): APIServices {
         ...
         val okHttpClient = OkHttpClient.Builder()
             ...
             .addInterceptor { chain ->
                 ...
                 builder.addHeader("Authorization", "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdWIiOiIyMTMiLCJleHAiOjE1NjM4NzM4NjN9.n0H1OFimt3GE0baQn1BulWIEJ-HMCfZi7osyrkcd0GE")
